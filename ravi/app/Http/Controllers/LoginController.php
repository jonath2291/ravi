...
class LoginController extends Controller
{
    ...
    public function get_menu_json($id){
        ...
        from segu.users u
        join segu.tusuario_rol ur on ur.id_usuario=u.id
    ...
    public function get_usuario($id)
    {
        ...
        $usuario_rol=DB::select("select 
                us.id_rol,
                r.nombre_rol
                from segu.tusuario_rol us
                join segu.trol r on r.id_rol=us.id_rol 
    ...
    public function guardar_usuario_rol($roles,$id_usuario){
        ...
        DB::delete("delete from segu.tusuario_rol where id_usuario = ? ",[$id_usuario]);
        for($i=0; $i<$longitud; $i++){      
            DB::insert('insert into segu.tusuario_rol (id_rol,id_usuario) values(?,?)',[$roles[$i]["id_rol"],$id_usuario]);
        }
    }
